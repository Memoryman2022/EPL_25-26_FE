import { calculatePredictionPoints } from '../src/models/scoring';
import { MatchResult, UserPrediction, User } from '../src/models/types';
...
scenarios.forEach(({ desc, result, prediction }) => {
  ...
  const pointsData = calculatePredictionPoints(result as any, prediction as any);
