...
// All teams ranked from 1-20 (strongest to weakest) Gameweek 24-26
// export const ALL_TEAMS: TeamRanking[] = [
//   { name: "Arsenal", rank: 1, group: 1 },
//   { name: "Manchester City", rank: 2, group: 1 },
//   { name: "Aston Villa", rank: 3, group: 1 },
//   { name: "Manchester United", rank: 4, group: 1 },
//   { name: "Chelsea", rank: 5, group: 1 },
//   { name: "Liverpool", rank: 6, group: 2 },
//   { name: "Fulham", rank: 7, group: 2 },
//   { name: "Brentford", rank: 8, group: 2 },
//   { name: "Newcastle United", rank: 9, group: 2 },
//   { name: "Everton", rank: 10, group: 2 },
//   { name: "Sunderland", rank: 11, group: 3 },
//   { name: "Brighton & Hove Albion", rank: 12, group: 3 },
//   { name: "Bournemouth", rank: 13, group: 3 },
//   { name: "Tottenham Hotspur", rank: 14, group: 3 },
//   { name: "Crystal Palace", rank: 15, group: 3 },
//   { name: "Leeds United", rank: 16, group: 4 },
//   { name: "Nottingham Forest", rank: 17, group: 4 },
//   { name: "West Ham United", rank: 18, group: 4 },
...
// All teams ranked from 1-20 (strongest to weakest) Gameweek 27-29
// export const ALL_TEAMS: TeamRanking[] = [
//   { name: "Arsenal", rank: 1, group: 1 },
//   { name: "Manchester City", rank: 2, group: 1 },
//   { name: "Aston Villa", rank: 3, group: 1 },
...
//   { name: "Liverpool", rank: 6, group: 2 },
//   { name: "Brentford", rank: 7, group: 2 },
//   { name: "Everton", rank: 8, group: 2 },
//   { name: "Bournemouth", rank: 9, group: 2 },
//   { name: "Newcastle United", rank: 10, group: 2 },
//   { name: "Sunderland", rank: 11, group: 3 },
//   { name: "Fulham", rank: 12, group: 3 },
//   { name: "Crystal Palace", rank: 13, group: 3 },
//   { name: "Brighton & Hove Albion", rank: 14, group: 3 },
//   { name: "Leeds United", rank: 15, group: 3 },
//   { name: "Tottenham Hotspur", rank: 16, group: 4 },
//   { name: "Nottingham Forest", rank: 17, group: 4 },
//   { name: "West Ham United", rank: 18, group: 4 },
//   { name: "Burnley", rank: 19, group: 4 },
//   { name: "Wolverhampton Wanderers", rank: 20, group: 4 },
...
// All teams ranked from 1-20 (strongest to weakest) Gameweek 30-32
// export const ALL_TEAMS: TeamRanking[] = [
//   { name: "Arsenal", rank: 1, group: 1 },
//   { name: "Manchester City", rank: 2, group: 1 },
//   { name: "Manchester United", rank: 3, group: 1 },
//   { name: "Aston Villa", rank: 4, group: 1 },
//   { name: "Chelsea", rank: 5, group: 1 },
//   { name: "Liverpool", rank: 6, group: 2 },
//   { name: "Brentford", rank: 7, group: 2 },
//   { name: "Everton", rank: 8, group: 2 },
//   { name: "Bournemouth", rank: 9, group: 2 },
//   { name: "Fulham", rank: 10, group: 2 },
//   { name: "Sunderland", rank: 11, group: 3 },
//   { name: "Newcastle United", rank: 12, group: 3 },
//   { name: "Crystal Palace", rank: 13, group: 3 },
//   { name: "Brighton & Hove Albion", rank: 14, group: 3 },
...
// All teams ranked from 1-20 (strongest to weakest) Gameweek 33-35
// export const ALL_TEAMS: TeamRanking[] = [
//   { name: "Arsenal", rank: 1, group: 1 },
//   { name: "Manchester City", rank: 2, group: 1 },
//   { name: "Manchester United", rank: 3, group: 1 },
...
//   { name: "Everton", rank: 8, group: 2 },
//   { name: "Brighton & Hove Albion", rank: 9, group: 2 },
//   { name: "Sunderland", rank: 10, group: 2 },
//   { name: "Bournemouth", rank: 11, group: 3 },
//   { name: "Fulham", rank: 12, group: 3 },
//   { name: "Crystal Palace", rank: 13, group: 3 },
//   { name: "Newcastle United", rank: 14, group: 3 },
//   { name: "Leeds United", rank: 15, group: 3 },
//   { name: "Nottingham Forest", rank: 16, group: 4 },
//   { name: "West Ham United", rank: 17, group: 4 },
//   { name: "Tottenham Hotspur", rank: 18, group: 4 },
//   { name: "Burnley", rank: 19, group: 4 },
//   { name: "Wolverhampton Wanderers", rank: 20, group: 4 },
// ];

// All teams ranked from 1-20 (strongest to weakest) Gameweek 36-38
export const ALL_TEAMS: TeamRanking[] = [
  { name: "Arsenal", rank: 1, group: 1 },
  { name: "Manchester City", rank: 2, group: 1 },
  { name: "Manchester United", rank: 3, group: 1 },
  { name: "Liverpool", rank: 4, group: 1 },
  { name: "Aston Villa", rank: 5, group: 1 },
  { name: "Bournemouth", rank: 6, group: 2 },
  { name: "Brentford", rank: 7, group: 2 },
  { name: "Brighton & Hove Albion", rank: 8, group: 2 },
  { name: "Chelsea", rank: 9, group: 2 },
  { name: "Everton", rank: 10, group: 2 },
  { name: "Fulham", rank: 11, group: 3 },
  { name: "Sunderland", rank: 12, group: 3 },
  { name: "Newcastle United", rank: 13, group: 3 },
  { name: "Leeds United", rank: 14, group: 3 },
  { name: "Crystal Palace", rank: 15, group: 3 },
  { name: "Nottingham Forest", rank: 16, group: 4 },
  { name: "Tottenham Hotspur", rank: 17, group: 4 },
  { name: "West Ham United", rank: 18, group: 4 },
  { name: "Burnley", rank: 19, group: 4 },
  { name: "Wolverhampton Wanderers", rank: 20, group: 4 },
];
