...
export const ALL_TEAMS: TeamRanking[] = [
  ...
  { name: "Bournemouth", rank: 2, group: 1 },
  { name: "Tottenham Hotspur", rank: 3, group: 2 },
  { name: "Sunderland", rank: 4, group: 2 },
  { name: "Manchester City", rank: 5, group: 1 },
  { name: "Manchester United", rank: 6, group: 2 },
  { name: "Liverpool", rank: 7, group: 1 },
  { name: "Aston Villa", rank: 8, group: 3 },
  { name: "Chelsea", rank: 9, group: 1 },
  { name: "Crystal Palace", rank: 10, group: 2 },
  { name: "Brentford", rank: 11, group: 3 },
  { name: "Newcastle United", rank: 12, group: 3 },
  { name: "Brighton & Hove Albion", rank: 13, group: 2 },
  { name: "Everton", rank: 14, group: 3 },
  { name: "Leeds United", rank: 15, group: 4 },
  { name: "Burnley", rank: 16, group: 4 },
  { name: "Fulham", rank: 17, group: 3 },
